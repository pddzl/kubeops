...
func (v *viewAuthorityMenuMysql) Initialize() error {
	...
	if err := global.KOP_DB.Exec(sql).Error; err != nil {
...
func (v *viewAuthorityMenuMysql) CheckDataExist() bool {
	err1 := global.KOP_DB.Find(&[]system.SysMenu{}).Error
	err2 := errors.New(fmt.Sprintf("Error 1146: Table '%v.%v' doesn't exist", global.KOP_CONFIG.Mysql.Dbname, v.TableName()))
