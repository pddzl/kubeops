...
func (m *menu) Initialize() error {
	entities := []system.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "role", Name: "role", Component: "view/rbac/role/list.vue", Sort: 3, Meta: system.Meta{Title: "Role", Icon: "chat-round"}},
		{MenuLevel: 0, Hidden: true, ParentId: "30", Path: "role/detail", Name: "role_detail", Component: "view/rbac/role/detail.vue", Sort: 4, Meta: system.Meta{Title: "Role详情", Icon: "chat-round"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "roleBinding", Name: "roleBinding", Component: "view/rbac/roleBinding/list.vue", Sort: 5, Meta: system.Meta{Title: "RoleBinding", Icon: "Cherry"}},
		{MenuLevel: 0, Hidden: true, ParentId: "30", Path: "roleBinding/detail", Name: "roleBinding_detail", Component: "view/rbac/roleBinding/detail.vue", Sort: 6, Meta: system.Meta{Title: "RoleBinding详情", Icon: "Cherry"}},
		{MenuLevel: 0, Hidden: false, ParentId: "30", Path: "clusterRole", Name: "clusterRole", Component: "view/rbac/clusterRole/list.vue", Sort: 7, Meta: system.Meta{Title: "ClusterRole", Icon: "Chicken"}},
