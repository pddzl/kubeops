    ...
    <div class="gva-table-box">
      <el-table :data="tableData">
        ...
        <el-table-column fixed="right" label="操作" width="240">
          <template #default="scope">
            <el-button icon="view" type="primary" link size="small" @click="viewServices(scope.row)">查看</el-button>
            <el-button icon="delete" type="primary" link size="small" @click="deleteServicesFunc(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
