      ...
      <el-table :data="tableData">
        <el-table-column label="名称" min-width="220">
          <template #default="scope">
            <router-link
              :to="{ name: 'configMap_detail', query: { configMap: scope.row.name, namespace: scope.row.namespace } }"
            >
        ...
        <el-table-column fixed="right" label="操作" width="240">
          <template #default="scope">
            <el-button icon="view" type="primary" link size="small" @click="viewConfigMap(scope.row)">查看</el-button>
