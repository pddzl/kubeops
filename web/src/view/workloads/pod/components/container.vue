      ...
      <div v-if="detail.livenessProbe" class="box">
        ...
        <div class="block">
          ...
          <div v-if="detail.livenessProbe.httpGet" class="column">
            ...
            <span class="content-shadow">{{ detail.livenessProbe.httpGet.scheme + '://[host]:' +
              detail.livenessProbe.httpGet.port + detail.livenessProbe.httpGet.path
            }}</span>
          </div>
        </div>
      </div>
      <div v-if="detail.readinessProbe" class="box">
        ...
        <div class="block">
          ...
          <div v-if="detail.readinessProbe.httpGet" class="column">
            <p>HTTP Healthcheck URI</p>
            <span class="content-shadow">{{ detail.readinessProbe.httpGet.scheme + '://[host]:' +
              detail.livenessProbe.httpGet.port + detail.livenessProbe.httpGet.path
            }}</span>
          </div>
        </div>
      ...
      <div v-if="detail.startupProbe" class="box">
        ...
        <div class="block">
          ...
          <div v-if="detail.startupProbe.httpGet" class="column">
            <p>HTTP Healthcheck URI</p>
            <span class="content-shadow">{{ detail.startupProbe.httpGet.scheme + '://[host]:' +
              detail.livenessProbe.httpGet.port + detail.livenessProbe.httpGet.path
            }}</span>
          </div>
        </div>
